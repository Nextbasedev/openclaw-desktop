        ...
        {suggestions.map((s) => (
          <button
            ...
            className={cn(
              ...
              "transition-[background-color,border-color,color,transform] duration-150 ease-out hover:-translate-y-px hover:border-primary/30 hover:bg-primary/10 hover:text-primary",
            )}
          >
            {s.chip}
          </button>
