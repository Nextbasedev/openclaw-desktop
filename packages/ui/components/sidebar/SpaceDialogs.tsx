  ...
  return (
    <>
      <Dialog open={renameOpen} onOpenChange={onRenameOpenChange}>
        <DialogContent className="overflow-hidden rounded-[22px] border border-black/[0.10] bg-[var(--glass-bg)] dark:border-black/70 p-0 sm:max-w-[460px]">
          <DialogHeader className="border-b border-black/[0.07] dark:border-white/[0.07] px-6 py-5 text-left">
            <DialogTitle className="text-sm font-medium text-foreground dark:text-white">Edit project</DialogTitle>
          ...
          <div className="px-6 py-5">
            <div className="mb-4 flex items-center gap-3.5">
              ...
              <div className="min-w-0 flex-1">
                <label className="mb-1 block text-[11px] font-medium text-cyan-700/80 dark:text-cyan-300/80" htmlFor="space-rename-input">
                  Project name
                </label>
                <input
            ...
            <div className="mb-4">
              <div className="mb-2 flex items-center gap-2 text-[11px] font-medium uppercase tracking-[0.04em] text-muted-foreground dark:text-white/45">
                ...
                {PROJECT_AVATAR_COLORS.map((color) => (
                  <button
                    ...
                    className={cn(
                      ...
                      color,
                      color === avatarColor && "ring-2 ring-cyan-200/60 ring-offset-2 ring-offset-background dark:ring-offset-[#1a1a1a]",
                    )}
            ...
            <div>
              <p className="mb-2 text-[11px] font-medium uppercase tracking-[0.04em] text-muted-foreground dark:text-white/45">Project emoji</p>
