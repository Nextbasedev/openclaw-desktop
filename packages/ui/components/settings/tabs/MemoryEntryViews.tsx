...
function MarkdownDocument({ content }: { content: string }) {
  return (
    <div className="prose prose-neutral dark:prose-invert max-w-none text-[13px] leading-7 prose-headings:scroll-mt-20 prose-headings:font-semibold prose-headings:tracking-tight prose-h1:text-2xl prose-h1:text-foreground prose-h2:mt-8 prose-h2:border-b prose-h2:border-border/30 prose-h2:pb-2 prose-h2:text-xl prose-h2:text-foreground prose-h3:text-base prose-h3:text-foreground prose-p:text-foreground/75 prose-a:text-violet-600 dark:prose-a:text-violet-300 prose-strong:text-foreground prose-code:rounded-md prose-code:bg-black/[0.06] dark:prose-code:bg-white/[0.07] prose-code:px-1.5 prose-code:py-0.5 prose-code:text-[12px] prose-code:text-violet-700 dark:prose-code:text-violet-200 prose-code:before:content-none prose-code:after:content-none prose-pre:border prose-pre:border-border/40 prose-pre:bg-black/[0.04] dark:prose-pre:bg-black/30 prose-blockquote:border-l-violet-400/50 prose-blockquote:text-muted-foreground prose-li:text-foreground/75 prose-hr:border-border/40 prose-table:text-[12px] prose-th:border prose-th:border-border/40 prose-th:bg-black/[0.035] dark:prose-th:bg-white/[0.04] prose-th:px-3 prose-th:py-2 prose-td:border prose-td:border-border/30 prose-td:px-3 prose-td:py-2">
