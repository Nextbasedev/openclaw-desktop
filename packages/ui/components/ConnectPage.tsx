  ...
  return (
    <div className="flex min-h-svh items-start justify-center p-6 pt-16">
      <div className="w-full max-w-lg space-y-6">
        ...
        {/* Guidance */}
        <Card className="border-ring/20 bg-card/80">
          <CardHeader>
            <CardTitle className="text-base">Quick guidance</CardTitle>
            <CardDescription>
              Use this when you are unsure what to paste above.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-3 text-sm text-muted-foreground">
            <div>
              <p className="font-medium text-foreground">Same computer</p>
              <p>
                Use <code className="rounded bg-muted px-1 py-0.5">ws://127.0.0.1:18789</code> when this app and OpenClaw are running on the same machine.
              </p>
            </div>
            <div>
              <p className="font-medium text-foreground">Remote server</p>
              <p>
                Use your server/Tailscale address with port <code className="rounded bg-muted px-1 py-0.5">18789</code>, for example <code className="rounded bg-muted px-1 py-0.5">ws://100.x.y.z:18789</code>.
              </p>
            </div>
            <div>
              <p className="font-medium text-foreground">Token</p>
              <p>
                Copy the gateway token from <code className="rounded bg-muted px-1 py-0.5">~/.openclaw/openclaw.json</code>, then click <span className="font-medium text-foreground">Test Connection</span> first.
              </p>
            </div>
          </CardContent>
        </Card>
