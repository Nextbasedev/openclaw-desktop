...
function defaultState(): SessionState {
  return { cursor: 0, messages: [], historyCoverage: "none", messageCount: null, status: "idle", statusLabel: null, pendingTools: [], spawnedSubagents: [], lastPatchAtMs: 0, activityStartedAtMs: 0, pendingDoneStatus: null, suppressAssistantAfterAbort: false }
}
