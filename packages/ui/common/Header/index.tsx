  ...
  const tabButton = (
    <div
      ...
      className={cn(
        ...
        activeAndFocused
          ? "z-20 overflow-visible border-zinc-200 bg-zinc-100 text-foreground shadow-[inset_0_1px_0_rgba(255,255,255,0.88)] before:pointer-events-none before:absolute before:bottom-0 before:-left-[10px] before:size-[10px] before:rounded-br-[10px] before:shadow-[4px_4px_0_4px_#f4f4f5] after:pointer-events-none after:absolute after:bottom-0 after:-right-[10px] after:size-[10px] after:rounded-bl-[10px] after:shadow-[-4px_4px_0_4px_#f4f4f5] dark:border-transparent dark:bg-background dark:shadow-none dark:before:shadow-[4px_4px_0_4px_var(--background)] dark:after:shadow-[-4px_4px_0_4px_var(--background)]"
          : isActive
            ? "z-10 overflow-visible border-zinc-200/70 bg-zinc-100/72 text-foreground/74 shadow-none before:pointer-events-none before:absolute before:bottom-0 before:-left-[10px] before:size-[10px] before:rounded-br-[10px] before:shadow-[4px_4px_0_4px_rgba(244,244,245,0.72)] after:pointer-events-none after:absolute after:bottom-0 after:-right-[10px] after:size-[10px] after:rounded-bl-[10px] after:shadow-[-4px_4px_0_4px_rgba(244,244,245,0.72)] dark:border-transparent dark:bg-background/72 dark:before:shadow-[4px_4px_0_4px_var(--background)] dark:after:shadow-[-4px_4px_0_4px_var(--background)]"
